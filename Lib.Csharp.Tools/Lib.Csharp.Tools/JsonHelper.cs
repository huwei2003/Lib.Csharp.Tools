...
namespace Lib.Csharp.Tools
{
    ...
    public class JsonHelper
    {
        ...
        public static string ToJsonOld(object jsonObject)
        {
            string jsonString = "{";
        ...
        public static List<T> ToListObject<T>(JArray strJson)
        {
            var list = strJson.ToObject<List<T>>();
            return list;
        }
